...
"请输入140~230之间的整数",
"请输入正确的网址",
"您输入的电子邮箱已经存在，请重新输入，或 <a href='http://www.shoudurc.com/personal/sys/login'>点此登录</a> 或 <a href='http://www.shoudurc.com/personal/sys/GetPassword' target='_blank'>取回密码</a>",
"两次输入的密码不相同，请重新输入",
"邮箱长度不能大于50字符")
var strError = '<img src="../Images/IconF.gif"/*tpa=http://www.shoudurc.com/Images/IconF.gif*/ />';
var strSuccess = '<img src="../Images/IconT.gif"/*tpa=http://www.shoudurc.com/Images/IconT.gif*/ />';
var strWaiting = '<img src="../Images/IconWait.gif"/*tpa=http://www.shoudurc.com/Images/IconWait.gif*/ />';
